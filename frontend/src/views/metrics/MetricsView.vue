...
<template>
  <div class="metrics-page">
    <div v-if="store.loading && !store.summary.qps" class="loading">Loading...</div>
    <template v-else>
      <div class="charts-grid">
        <div class="panel">
          <div class="panel-header"><h3>Requests / sec</h3></div>
          <div class="panel-body">
            <QpsChart :value="store.summary.qps" />
          </div>
        </div>
        <div class="panel">
          <div class="panel-header"><h3>Latency</h3></div>
          <div class="panel-body">
